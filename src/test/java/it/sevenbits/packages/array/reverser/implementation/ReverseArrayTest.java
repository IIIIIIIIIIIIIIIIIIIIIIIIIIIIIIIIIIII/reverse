...
public class ReverseArrayTest {
    ...
    public void reverseOddNumberOfElementsTest() throws ReverseArrayException {
        ...
        assertEquals("Method reverseArray does not work correctly with odd number of elements", new Integer[] {12, 11, 10, 9, 5}, array);
    }
    ...
    public void reverseEvenNumberOfElementsTest() throws ReverseArrayException {
        ...
        IReverseArray invertArray = new ReverseArray();
        invertArray.reverseArray(container);
        assertEquals("Method reverseArray does not work correctly with even number of elements", new String[] {"six", "five", "four", "three", "two", "one"}, array);
    }
